---
name: odin-complete-section
description: Complete the current Odin section when the user says the section is finished, checking notes and recording completion without starting the next section.
---

# Complete an Odin section
...
the next section, initialize its notes, change README to it, or imply it has begun.

Validate and propose a single section-scoped commit such as
`notes(fnd-s05-css-foundations): mark section complete`, then follow the root
